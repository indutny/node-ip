...
ip.isPrivate = function isPrivate(addr) {
  return ip.isLoopback(addr) ||
    addr.match(/^10\.(\d{1,3})\.(\d{1,3})\.(\d{1,3})/) != null ||
    addr.match(/^192\.168\.(\d{1,3})\.(\d{1,3})/) != null ||
    addr.match(
        /^172\.(1[6-9]|2\d|30|31)\.(\d{1,3})\.(\d{1,3})/) != null ||
    addr.match(/^127\.(\d{1,3})\.(\d{1,3})\.(\d{1,3})/) != null ||
    addr.match(/^169\.254\.(\d{1,3})\.(\d{1,3})/) != null ||
